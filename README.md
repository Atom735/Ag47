...
| --------------------- | --------------------------------- | ------------------------------------- |
| [ ] `CODEPAGE_ID`     | Номер кодировки                   | `1251`                                |
| [ ] `CODEPAGE`        | Сокращённое название кодировки    | `windows-1251`                        |
| [ ] `CODEPAGE_FULL`   | Полное название кодировки         | `ANSI Cyrillic; Cyrillic (Windows)`   |
| [ ] `CODEPAGE_A1`     | Количество очков кодировки        | `20594414`                            |
| [ ] `CODEPAGE_A2`     | Количество очков кодировки        | `11217259`                            |
| [ ] `CODEPAGES`       | Пройтись по всем кодировкам       | ---                                   |
| [ ] `ENDOFLINE`       | Символ конца строки               | `CRLF`                                |
| [ ] `ENDOFLINE_EX`    | Символ конца строки расширенное   | `CRLF (Windows)`                      |
| [ ] `ORIGIN_PATH`     | Путь к оригиналу файла            | `F:\LAS\BK1.LAS`                      |
| [ ] `NLINE`           | Номер строки                      | `13`                                  |
| [ ] `SECTION`         | Символ секции                     | `V`                                   |
| [ ] `SECTION_FULL`    | Полная стркоа секции              | `Version information`                 |
| [ ] `S_MNEM`          | Мнемоника                         | `DFD`                                 |
| [ ] `S_UNIT`          | Размерность                       | `K/M3`                                |
| [ ] `S_DATA`          | Данные                            | `1200.0000`                           |
| [ ] `S_DESC`          | Описание                          | `Mud Weight`                          |
